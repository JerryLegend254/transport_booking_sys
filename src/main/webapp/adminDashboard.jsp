...
<div class="flex justify-between items-center bg-blue-600">
    ...
    <div class="flex flex-row items-center">
        ...
        <a href="/adminSO" class="bg-blue-900 py-2 px-4 font-bold text-white rounded-lg mr-5 font-serif">SIGN OUT</a>
    </div>

</div>
<div class="flex">
    <div class="w-1/5 bg-blue-600 h-screen space-y-1 flex flex-col">
        <a class="px-4 text-white font-sm py-2 border-b-2 border-t-2" onclick="loadContent('addVehicle')" href="#">Add Vehicle</a>
        <a class="px-4 text-white font-sm py-2 border-b-2" onclick="loadContent('scheduleTrip')" href="#">Schedule Trip</a>
        <a class="px-4 text-white font-sm py-2 border-b-2" onclick="loadContent('viewBookings')" href="#">View Bookings</a>
