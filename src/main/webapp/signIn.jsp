...
<%@include file="templates/header.jsp"%>
  ...
  <div class="flex justify-center align-center">
    <p class="text-center px-4 py-2 w-1/3 mt-2 self-center rounded-lg font-bold">${messages}</p>
  </div>
  <form method="post" action="/passengerSignIn" class="flex justify-center pt-8">
    <div class="grid mx-5 my-2 w-[432px] space-y-3">
      ...
      <p>Don't Have an Account? <a href="/passengerReg">Register</a></p>
    </div>
  </form>
